...
from DataSet_ner import DataSet
import sys
reload(sys)
sys.setdefaultencoding("utf-8")

class LBconfig():
    single_word_len = 20  # fro cnn
    vocab_size = 0
    ...
    file_path = "../data/conll2003ner.txt"
    model_path = "../saved_model_ner/"
    export_path = "../export_model_ner/"


def create_model(config,session,glove):
    model = labelingModel(config,glove)
...
def test(sess,model,brown,input_data,conf):
    #conf = LBconfig()
